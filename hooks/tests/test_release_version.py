"""Version / changelog checks for the 1.3.8 review-wave-consolidation release.
...
def test_plugin_json_version_is_1_3_8():
...
def test_changelog_has_1_3_8_entry():
