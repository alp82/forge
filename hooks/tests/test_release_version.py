"""Version / changelog checks for the 1.3.10 guard-hook-bug-fixes release.
...
1.3.7 -> 1.3.8 -> 1.3.9, now 1.3.9 -> 1.3.10).
...
def test_plugin_json_version_is_1_3_10():
...
def test_changelog_has_1_3_10_entry():
