...
# --- TC-M8 ---
def test_stage_count_stays_41_and_absence_is_valid():
    """REUSE-GUARD: stage count is 41 (43 after the review-wave consolidation and
    the clarifier merge, then -2 for the capture-agent and adr-drafter removal)
    and a
    ...
    assert len(stages) == 41, f"stage count must remain 41, got {len(stages)}"
