...
review lenses, the intent stages, the generative prototypers, the implementer, the
investigators, and the capture/ADR/setup authors); `sonnet` for the stages that execute
